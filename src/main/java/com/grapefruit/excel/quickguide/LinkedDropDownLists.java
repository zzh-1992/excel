...
public class LinkedDropDownLists {
    ...
    // 原始代码: github LinkedDropDownLists https://github.com/i5possible/excel-mongodb-data-exchange/commit/78228a4adb7febef6a9f98881929b189ae8f0ce2
    // 修改点: 将数据源独立于一个dbSheet,对应点代码修改为 name.setRefersToFormula(DB_SHEET + "!$A$12:$G$12");
    private static final String DB_SHEET = "dbSheet";
    ...
    LinkedDropDownLists(String workbookName) throws IOException {
        ...
        Sheet dbSheet = workbook.createSheet(DB_SHEET);

        LinkedDropDownLists.buildDataSheet(dbSheet);
    ...
    private static final void buildDataSheet(Sheet dataSheet) {
        ...
        name.setRefersToFormula(DB_SHEET + "!$A$11:$C$11");
        ...
        name = dataSheet.getWorkbook().createName();
        name.setRefersToFormula(DB_SHEET + "!$A$12:$G$12");
        ...
        name = dataSheet.getWorkbook().createName();
        name.setRefersToFormula(DB_SHEET + "!$A$13:$H$13");
        ...
        name = dataSheet.getWorkbook().createName();
        name.setRefersToFormula(DB_SHEET + "!$A$14:$F$14");
